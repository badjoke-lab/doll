...
encoded = bytearray()
encoded.extend((payload / "part-00.b64").read_bytes())
encoded.extend((payload / "part-01-00.b64").read_bytes())
encoded.extend(base64.b64decode((payload / "part-01-01.b64x").read_bytes()))
encoded.extend(base64.b64decode((payload / "part-01-02.b64x").read_bytes()))
...
encoded.extend(base64.b64decode(nested, validate=True))
