...
Implemented against the IMP-048 runtime contract. This slice adds a concrete adapter but does not claim that Ollama or a model is installed or usable on the project owner's machine.
