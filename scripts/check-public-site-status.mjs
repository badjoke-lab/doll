...
expect(
  status.phase?.id === "6" &&
    ...
    status.phase?.next_implementation === 89,
...
expect(
  status.model_runtime.message.includes("through IMP-088") &&
